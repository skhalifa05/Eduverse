...
<h3 style="padding-left: 22%;margin-top: 0%;color: #F0A61F;"><?php echo $center->getName(); ?></h3>
            ...
            <div class="container" style="flex-wrap: initial;">
                    <div onclick="window.location.href='archive_summary.php?Year=2022'"  class="card">
                        <div class="iconn">
                        ...
                        <div class="contentBx">
                            ...
                            <h1 style="color: #FFFFFF; font-size: 19px;">2022/2023</h1>
                            <h3 style="color: #FFFFFF; font-size: 16px;">November, june Sessions</h3>

                        </div>

                    </div>
                    <div onclick="window.location.href='archive_summary.php?Year=2023'"  class="card">
                        <div class="iconn">
                            <img src="https://brightside-edu.com/Images/coedublack.png" alt="Codeology Education">
                        </div>
                        <!--<div class="imgBx">
                        ...
                        <div class="contentBx">
                            ...
                            <h1 style="color: #FFFFFF; font-size: 19px;">2023/2024</h1>
                            <h3 style="color: #FFFFFF; font-size: 16px;">November, june Sessions</h3>

                        </div>

                    </div>
                    <div onclick="window.location.href='archive_summary.php?Year=2024'"  class="card">
                        <div class="iconn">
                            <img src="https://brightside-edu.com/Images/coedublack.png" alt="Codeology Education">
                        </div>
                        <!--<div class="imgBx">
                        ...
                        <div class="contentBx">
                            ...
                            <h1 style="color: #FFFFFF; font-size: 19px;">2024/2025</h1>
                            <h3 style="color: #FFFFFF; font-size: 16px;">November, june Sessions</h3>
