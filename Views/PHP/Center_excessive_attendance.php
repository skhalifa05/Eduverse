...
if(isset($conn) && isset($center) && ($center instanceof Center)){
        ...
        <ul class="optionsBar">
           ...
           <li class="menuItem ">
                <a href="Center_Student_List.php" class="menuOption">
                    <i class="fa-solid fa-user" aria-hidden="true"></i><h5 class="menuText open2" >Student List</h5>
                </a>
            </li>
                       <li class="menuItem active">
                <a href="Center_excessive_attendance.php" class="menuOption">
                    <i class="fa fa-history" style="color: #fff" aria-hidden="true"></i><h5 class="menuText open2" style="color: #fff" >Excessive Absence</h5>
                </a>
            </li>
            <li class="menuItem">
    ...
    <section class="dashboard">
        ...
        <div style="margin-bottom: 50px" class="content">
                    ...
                    <div class="titlesmall">
                        ...
                        <span class="text"><?php
                            if (isset($_GET['Year'])){
                                ...
                                echo 'Excessive Absence Students';
                            }
                            ?>
                        </span>
                    </div>
            ...
            <div class="searches">
                ...
                <input type="text" id="myLevels" onkeyup="myCourses()" placeholder="Search by Course.." title="Type in a level">
            ...
            <div class="activity-data">
                <table id="myTable">
                    ...
                    <?php
                        ...
                        $data = $center->GetExcessiveAbsence($conn);
                        $i = 1;
    ...
    <script src="../JS/Center_excessive.js"></script>
